...
from hyperframe.frame import Frame, SettingsFrame, PriorityFrame, HeadersFrame, DataFrame, PushPromiseFrame
from hyperframe.frame import PingFrame, WindowUpdateFrame, GoAwayFrame, ContinuationFrame, RstStreamFrame, ExtensionFrame
...
class PushPromiseFrameHandler(FrameHandler):
    ...
    async def validate(self, frame: PushPromiseFrame, reader: StreamReader, writer: StreamWriter,
                       ...
                       settings: Http2Settings):
        raise NotImplementedError(f'Unexpected situation. because server never got PushPromisedFrame.')
